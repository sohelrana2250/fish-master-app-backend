...
if (!config.firebase_account_key.type || !config.firebase_account_key.project_id || 
     !config.firebase_account_key.private_key_id || !config.firebase_account_key.private_key || 
     !config.firebase_account_key. client_email ||  !config.firebase_account_key. client_id ||  !config.firebase_account_key.auth_uri || 
     !config.firebase_account_key.token_uri || !config.firebase_account_key.auth_provider_x509_cert_url  || !config.firebase_account_key.client_x509_cert_url ||  
...
admin.initializeApp({
     credential: admin.credential.cert({
       ...
       auth_provider_x509_cert_url: config.firebase_account_key.auth_provider_x509_cert_url,
